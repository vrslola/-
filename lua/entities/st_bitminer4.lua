...
if SERVER then
    ...
    function ENT:Initialize()
        ...
        timer.Create( "BitcoinMine" .. self:EntIndex(), ST_CONFIGS[ "STBitMining2" ][ "ModelST4Delay" ], 0, function()
            self:SetNWFloat( "HeldBTC", self:GetNWFloat( "HeldBTC" ) + ST_CONFIGS[ "STBitMining2" ][ "ModelST4Value" ] )
        end )
    end
